...
<div class="paragraph">
<p>There are two main technology stacks that can transform AsciiDoc into HTML5 / reveal.js:</p>
</div>
<div class="ulist">
<ul>
<li>
...
<div class="paragraph">
<p>Right now the Asciidoctor / Ruby stack is the better tested one but with the changes in v1.1.0 they have feature parity.</p>
</div>
</div>
</div>
<div class="sect1">
...
<div class="literalblock">
<div class="content">
<pre>$ git clone -b 3.6.0 --depth 1 https://github.com/hakimel/reveal.js.git</pre>
</div>
</div>
</li>
</ol>
...
<div class="paragraph">
<p>First you must install and configure <a href="https://nodejs.org/en/download/">Node.js</a> on your machine.</p>
</div>
</div>
<div class="sect2">
...
<div class="literalblock">
<div class="content">
<pre>$ npm i --save asciidoctor-reveal.js</pre>
</div>
</div>
</div>
<div class="sect2">
<h3 id="_rendering_the_asciidoc_into_slides_2">Rendering the AsciiDoc into slides</h3>
<div class="paragraph">
<p>Once the package is installed, you can convert AsciiDoc files using reveal.js converter.
Here we are converting a file named <code>presentation.adoc</code> into a reveal.js presentation using Node.js:</p>
</div>
<div class="listingblock">
<div class="title">asciidoctor-revealjs.js</div>
<div class="content">
<pre class="highlight"><code class="language-javascript" data-lang="javascript">// Load asciidoctor.js and asciidoctor-reveal.js
...
<div class="paragraph">
<p>To render the slides, run:</p>
</div>
<div class="literalblock">
<div class="content">
<pre>node asciidoctor-revealjs.js</pre>
</div>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>In previous snippet we are creating a slide titled Slide One with bullets and another one titled Slide Two with centered text (reveal.js&#8217; default behavior) with <a href="https://github.com/hakimel/reveal.js#speaker-notes">speaker notes</a>.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>Then open your browser at: <a href="http://localhost:5000/" class="bare">http://localhost:5000/</a></p>
</div>
</div>
<div class="sect2">
...
<div class="content">
<pre class="highlight"><code class="language-asciidoc" data-lang="asciidoc">= Concealed Slide Titles
:backend: revealjs
...
<td class="content">
Background images file names are now relative to the <code>:imagedir:</code> attribute if set.
</td>
</tr>
</table>
</div>
...
<div class="paragraph">
<p>To enable <a href="https://highlightjs.org/">highlight.js</a> for syntax highlighting (which is the <code>revealjs</code> default):</p>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-asciidoc" data-lang="asciidoc">= Title slide
...
<div class="paragraph">
<p>With enabled source-highlighter you can write code blocks as usual:</p>
</div>
<div class="listingblock">
<div class="content">
...
<div class="paragraph">
<p>Alternatively, you can use <a href="http://coderay.rubychan.de">Coderay</a> or <a href="http://pygments.org">Pygments</a> as the highlighter.
These handle callouts correctly.</p>
</div>
<div class="paragraph">
<p>To use <a href="http://coderay.rubychan.de">Coderay</a>:</p>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-asciidoc" data-lang="asciidoc">= Title slide
...
<div class="paragraph">
<p>To use <a href="http://pygments.org">Pygments</a>:</p>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-asciidoc" data-lang="asciidoc">= Title slide
...
<div class="content">
<pre class="highlight"><code class="language-asciidoc" data-lang="asciidoc">= EPIC TITLE
:imagesdir: images
...
<div class="sect2">
<h3 id="_css_override">CSS override</h3>
<div class="paragraph">
...
For example, by combining this feature with the <a href="#_css_override">CSS override</a> one, you can alter fonts for specific pages with this CSS:</p>
</div>
<div class="listingblock">
<div class="content">
...
<div class="sectionbody">
<div class="paragraph">
<p>There are some attributes that can be set at the top of the document which they are specific of <code>revealjs</code> converter.</p>
</div>
<div class="admonitionblock note">
<table>
<tr>
...
<a href="https://cdnjs.cloudflare.com/ajax/libs/reveal.js/3.3.0" class="bare">https://cdnjs.cloudflare.com/ajax/libs/reveal.js/3.3.0</a></p></td>
</tr>
<tr>
...
<div class="sectionbody">
<div class="paragraph">
<p>Copyright &#169; 2012-2017 Olivier Bilodeau, Guillaume Grossetie, Dan Allen, Rahman Usta, Charles Moulliard and the Asciidoctor Project.
...
<div id="footer">
<div id="footer-text">
Last updated 2018-01-02 20:16:57 EST
</div>
</div>
</body>
</html>